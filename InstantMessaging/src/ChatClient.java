...
{  
	...
	private Button    send    = new Button("Send"), connect = new Button("Connect"), quit = new Button("Exit");
	private String    serverName = "localhost";
	private int       serverPort = 1234;
	
	// initializing simple interface 
	public void init(){  
	    ...
	    Label title = new Label("Simple messenger", Label.CENTER);
